...
function SearchSection({ onSearchInput }) {
  return (
    <div className="p-10 text-white flex flex-col justify-center items-center bg-gradient-to-br from-primary via-blue-500 to-purple-500 ">
      <h2 className="text-3xl font-bold">Cerca Tra Tutti i Templates</h2>
      <p>Cosa vuoi creare oggi?</p>

      <div className="w-full flex justify-center">
        <div className="flex gap-2 p-2 my-5 items-center border rounded-md bg-white w-[50%]">
